        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" id="datepicker1" class="form-control date"  name="fromdate" placeholder="From Date" required>
            </div>
            <div class="form-group">
              <input type="text" id="datepicker2" class="form-control date" name="todate" placeholder="To Date" required>
            </div>
            <div class="form-group">
